...
public class PopUpMenu extends JPopupMenu {
    ...
    public static java.awt.event.MouseListener simpleCopyPaste(Langs.Locale lingua, javax.swing.JComponent fil) {
        ...
        itens[0] = new JMenuItem(titulos[0]);
        itens[1] = new JMenuItem(titulos[1]);
        ...
        ActionListener list2 = (ActionEvent ex) -> {
            ...
            if (t.isDataFlavorSupported(DataFlavor.stringFlavor)) {
                try {
                    ...
                    if (fil instanceof javax.swing.JTextField) {
                        javax.swing.JTextField texto = ((javax.swing.JTextField) fil);
        ...
        itens[0].addActionListener(list);
        itens[1].addActionListener(list2);
                ...
                if (e.getButton() == MouseEvent.BUTTON3) {
                    ...
                    if (t.isDataFlavorSupported(DataFlavor.stringFlavor)) {
                        try {
                            String colarl = "";
                            Object ol = t.getTransferData(DataFlavor.stringFlavor);
                            colarl = (String) t.getTransferData(DataFlavor.stringFlavor);
                            if (colarl.equals("")) {
